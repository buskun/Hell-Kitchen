...
public class panFrame extends JFrame {
    ...
    public panFrame(ImageLoader imageLoader, AudioLoader audioLoader, Consumer<String> getItemListener) {
        setTitle("pan");
        ...
        cm.setIcon(contentPane, imageLoader.getIcon("bgPan"), CM.size(100, 100));
